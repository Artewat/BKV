...
#define CLK_PIN 13     // CLK или SCK | CLK or SCK 
#define DATA_PIN 11   // DATA или MOSI | DATA or MOSI
#define CS_PIN 10      // CS или SS | CS or SS

MD_Parola P = MD_Parola(HARDWARE_TYPE, CS_PIN, MAX_DEVICES);
MD_MAX72XX mx = MD_MAX72XX(HARDWARE_TYPE, CS_PIN, MAX_DEVICES);
const char *outputText = "ЛЮБАЯ НАДПИСЬ";  // Введите текст в кавычки | Enter text in quotes
